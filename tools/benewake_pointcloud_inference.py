#!/home/ubuntu/miniconda3/envs/centerpoint/bin/python
import rospy
import ros_numpy
import numpy as np
import copy
...
def remove_low_score_nu(image_anno, thresh):
    ...
    car_indices =                  get_annotations_indices(0, 0.1, label_preds_, scores_)
    truck_indices =                get_annotations_indices(1, 0.3, label_preds_, scores_)
...
class Processor_ROS:
    ...
    def read_config(self):
        ...
        self.net.load_state_dict(torch.load(self.model_path,  map_location='cpu')["state_dict"])
    ...
    def run(self, points):
        ...
        outputs = remove_low_score_nu(outputs, 0.1)
...
if __name__ == "__main__":
    ...
    global proc
    ## CenterPoint
    config_path = '/home/ubuntu/CLionProjects/catkin_ws/src/test_node/scripts/CenterPoint_new/configs/mykitti/centerpoint_pp_02voxel_two_pfn.py'
    model_path = '/home/ubuntu/PycharmProjects/det3/CenterPoint/work_dirs/centerpoint_pp_02voxel_two_pfn/latest.pth'
    ...
    sub_lidar_topic = [
        "/benewake_horn_x2_ros_node/benewake_pointcloud",
        "/neuvition_cloud_tranform",
        "/cloud_publish",
        "/rslidar_points",
